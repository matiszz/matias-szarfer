  ...
  return (
    <div key="1" className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900 font-mono">
      ...
      <main className="flex-1">
        <section className="w-full py-24 flex flex-col items-center justify-center bg-gradient-to-r from-blue-500 to-purple-500 text-white">
          <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">Matias Szarfer</h1>
          <h2 className="mt-4 text-2xl font-medium">Computer Scientist | CTO & Co-Founder of Trialing</h2>
          <Button
        ...
        <section className="w-full py-12 md:py-24 lg:py-32" id="about">
          <div className="container px-4 md:px-6">
            ...
            <p className="mt-4 max-w-[600px] text-gray-500 md:text-xl/relaxed dark:text-gray-400">
              I am a seasoned computer scientist with a passion for driving technological innovation. As the CTO and
              Co-Founder of Trialing, I strive to leverage cutting-edge technologies to deliver exceptional solutions
              for our clients.
            </p>
          </div>
        </section>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-400">
                    As the CTO and Co-Founder of Trialing, I lead a team of dedicated professionals to provide
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-400">
                    I have a rich history of working with a variety of technology companies, bringing innovative
        ...
        <section className="w-full py-12 md:py-24 lg:py-32" id="contact">
          <div className="container px-4 md:px-6">
            ...
            <p className="mt-4 max-w-[600px] text-gray-500 md:text-xl/relaxed dark:text-gray-400">
              Feel free to reach out if you're looking for a collaborator, or just to say hi. My inbox is always open.
            </p>
            <a href="#" rel="noopener noreferrer" target="_blank">
              <Button className="mt-6 py-2 px-6 text-gray-700 border-gray-700 rounded-full" variant="outline">
                Book a call
              </Button>
            </a>
            <p className="mt-4 text-gray-500 md:text-xl/relaxed dark:text-gray-400">
              Or connect with me on
              <Link className="ml-2 text-blue-600 hover:underline" href="#" rel="noopener noreferrer" target="_blank">
                LinkedIn
              </Link>
              .
            </p>
